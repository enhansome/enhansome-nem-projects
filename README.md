# Awesome NEM Projects with stars
...
* [PacNEM](https://www.pacnem.com) - Check [Source](https://github.com/evias/pacNEM) ⭐ 21 | 🐛 1 | 🌐 JavaScript | 📅 2026-06-09 - Free & Open Source Node.js Autonomous Game using the NEM blockchain.
* [NEMonster](https://github.com/aenima86/NEMonster) ⭐ 4 | 🐛 0 | 🌐 JavaScript | 📅 2018-08-10 - A witty little collection game based on the NEM blockchain..
...
* [NEM DNS](http://nem-dns.bitballoon.com) - Check [Source](https://github.com/aenima86/NEM-DNS) ⭐ 14 | 🐛 1 | 🌐 JavaScript | 📅 2018-11-07 - Decentralized, censorship free and updatable DNS.
* [NEM Microwallet](https://chrome.google.com/webstore/detail/nem-microwallet/dhjphghceddgjhboapfeeonimnihpkkn) - Check [Source](https://github.com/anrodon/nem-microwallet) ⚠️ Archived - Simple and easy to use wallet in Chrome.
...
* [NEM krs](https://github.com/aenima86/NEMkrs) ⭐ 7 | 🐛 0 | 🌐 JavaScript | 📅 2018-11-08 - Key Recovery Service (KRS).
...
* [Blockstart token sale api](https://github.com/blockstart/nem-coinbase-token-sale-api) ⭐ 19 | 🐛 0 | 🌐 TypeScript | 📅 2018-06-12 - This repo provides all of the code needed to operate a token sale on the NEM blockchain (api).
* [NEM Trezor Standalone](https://github.com/saleemrashid/nem-trezor-standalone/) ⭐ 13 | 🐛 0 | 🌐 HTML | 📅 2018-01-15 - Offline tool for recovering NEM private keys from BIP39 mnemonics and importing them into NanoWallet.
* [Blockstart token sale web](https://github.com/blockstart/nem-coinbase-token-sale-website) ⭐ 11 | 🐛 1 | 🌐 TypeScript | 📅 2018-06-28 - This repo provides all of the code needed to operate a token sale on the NEM blockchain (website).
* [Nagit](https://github.com/ccastromar/nagit) ⭐ 4 | 🐛 2 | 🌐 JavaScript | 📅 2019-04-15 - NEM API Graphical Interactive Tool for testing REST APIs calling NIS Nodes.
* [XEMSign](https://github.com/kodty/MultisigTransactionSigner) ⭐ 3 | 🐛 0 | 🌐 C# | 📅 2017-11-12 - Simple bot for signing XEM multisignature transactions with optional signing rules.
...
* [NanoWallet](https://github.com/NemProject/NanoWallet) ⚠️ Archived - Official NEM Wallet.
* [CacheWallet](https://github.com/cache-official/cache-wallet) ⭐ 20 | 🐛 2 | 🌐 JavaScript | 📅 2018-06-21 - The official cross platform wallet for the Cache cryptocurrency.
* [RaccoonWallet](https://github.com/SasakiYuki/RaccoonWallet) ⭐ 20 | 🐛 32 | 🌐 Kotlin | 📅 2018-12-16 - NEM Mobile Wallet app developed in Japan aiming for the easiest ease of use in the world.

## Wrappers

* [JavaScript](https://github.com/QuantumMechanics/NEM-sdk) ⭐ 133 | 🐛 33 | 🌐 JavaScript | 📅 2023-10-25
...
* [Python](https://github.com/namuyan/nem-python) ⚠️ Archived
* [Java](https://github.com/NEMPH/nem-apps-lib) ⭐ 16 | 🐛 10 | 🌐 Java | 📅 2018-08-06
* [Python](https://github.com/semolex/nis-python-client) ⚠️ Archived
* [PHP](https://github.com/namuyan/NEM-Api-Library) ⚠️ Archived
* [Java](https://github.com/rosklyar/nem-library) ⭐ 6 | 🐛 2 | 🌐 Java | 📅 2018-03-27
* [PHP](https://github.com/tomotomo9696/NEMTools_PHP) ⭐ 5 | 🐛 1 | 🌐 PHP | 📅 2018-08-05
